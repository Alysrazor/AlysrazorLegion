/*
 * Created by Alysrazor Administrator of Stormforge
 *
...
DoorData const doorData[] =
{
   ...
   { GO_MOON_CHAMBER_HOLE,      DATA_SISTERS_OF_THE_MOON,        DOOR_TYPE      },
   { GO_MOON_CHAMBER_MISSILE,   DATA_SISTERS_OF_THE_MOON,        DOOR_TYPE      },
};
